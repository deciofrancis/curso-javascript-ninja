...
carro.addPessoas = function(numPessoas) {
  var totalPessoas = numPessoas + carro.quantidadesPessoas;
  ...
  if(totalPessoas > carro.assentos) {
    var quantosCabem = carro.assentos - carro.quantidadesPessoas;
    if (quantosCabem === 1){
       return 'Só cabe mais ' + quantosCabem + ' pessoa!';
    }return 'Só cabem mais ' + quantosCabem + ' pessoas!';
  }

  carro.quantidadesPessoas += numPessoas;
