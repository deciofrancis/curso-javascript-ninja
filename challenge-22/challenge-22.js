  (function(win, doc) {
    ...
    */
    ...
    function justNumbers(stringNum) {
      return stringNum.replace(/\D+/g, ',').split(',');
    }

    console.log(justNumbers('1teste3,9teste 4'));
